...
class VendorDataTable extends BaseDataTable
{
    ...
    protected function getColumns()
    {
        $data = [
            ...
            __('Vendor Name') => ['data' => 'vendor_name', 'name' => 'vendor_name', 'visible' => false,'title' => __('Vendor Name')],
            ...
            __('Office (Call) #') => ['data' => 'office', 'name' => 'office', 'title' => __('Office (Call) #')],
            __('Mobile (Text) #') => ['data' => 'cell', 'name' => 'cell', 'title' => __('Mobile (Text) #')],
            __('Street Address') => ['data' => 'street_address', 'name' => 'street_address', 'visible' => false, 'title' => __('Street Address')],
            ...
            __('app.city') => ['data' => 'city', 'name' => 'city', 'title' => __('app.city')],
             __('Zip Code') => ['data' => 'zip_code', 'name' => 'zip_code', 'visible' => false, 'title' => __('Zip Code')],
           ...
           // __('Vendor W9 Expiry') => ['data' => 'wnine_doc_expiry', 'name' => 'coi_wnine_expiry', 'visible' => true,'title' => __('Vendor W9 Expiry')],
            ...
            __('Waiver Status') => ['data' => 'waiver_form_status', 'name' => 'waiver_form_status', 'visible' => false, 'title' => __('Waiver Status')],
            __('Waiver Sent Date') => ['data' => 'form_sent_date', 'name' => 'form_sent_date', 'visible' => false, 'title' => __('Waiver Sent Date')],
            __('Waiver Signed Date') => ['data' => 'waiver_signed_date', 'name' => 'waiver_signed_date', 'visible' => false, 'title' => __('Waiver Signed Date')],
