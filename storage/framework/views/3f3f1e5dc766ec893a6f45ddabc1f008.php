                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        ...
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 sub-category"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=sub-category" role="tab"
                               aria-controls="nav-sub-category"
                               aria-selected="true"><?php echo app('translator')->get('modules.projects.projectsubcategory'); ?>
                            </a>

                            <a class="nav-item nav-link f-15 type"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=type" role="tab"
                               aria-controls="nav-type"
                               aria-selected="true"><?php echo app('translator')->get('Project Type'); ?>
                            </a>
                            <a class="nav-item nav-link f-15 priority"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=priority" role="tab"
                               aria-controls="nav-priority"
                               aria-selected="true"><?php echo app('translator')->get('Project Priority'); ?>
                            </a>
                            <a class="nav-item nav-link f-15 propertytype"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=propertytype" role="tab"
                               aria-controls="nav-propertytype"
                               aria-selected="true"><?php echo app('translator')->get('Property Type'); ?>
                            </a> <a class="nav-item nav-link f-15 occupancystatus"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=occupancystatus" role="tab"
                               aria-controls="nav-occupancystatus"
                               aria-selected="true"><?php echo app('translator')->get('Occupancy Status'); ?>
                            </a>
                            </a> <a class="nav-item nav-link f-15 delayedby"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=delayedby" role="tab"
                               aria-controls="nav-delayedby"
                               aria-selected="true"><?php echo app('translator')->get('Delayed By'); ?>
                            </a> <a class="nav-item nav-link f-15 contractortype"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=contractortype" role="tab"
                               aria-controls="nav-contractortypr"
                               aria-selected="true"><?php echo app('translator')->get('Contractor Type'); ?>
                            </a> <a class="nav-item nav-link f-15 cancelledreason"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=cancelledreason" role="tab"
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addProjectSubCategory','class' => 'sub-category-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Sub-Category'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'importProjectSubCategory','class' => 'sub-category-btn d-none mb-2 actionBtn ml-2']); ?> <?php echo app('translator')->get('Import'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'exportProjectSubCategory','class' => 'sub-category-btn d-none mb-2 actionBtn ml-2']); ?> <?php echo app('translator')->get('Export'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad)): ?>
<?php $attributes = $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad; ?>
...
<?php $component = App\View\Components\Forms\LinkSecondary::resolve(['link' => route('project-settings.exportProjectSubCategory')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'sub-category-btn d-none mb-2 actionBtn mt-1 ml-2']); ?>
                        <i class="fa fa-file-export"></i> <?php echo app('translator')->get('Export'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addProjectType','class' => 'type-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Type'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addProjectPriority','class' => 'priority-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Priority'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addPropertyType','class' => 'propertytype-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Property Type'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addOccupancyStatus','class' => 'occupancystatus-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Occupancy Status'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addDelayedBy','class' => 'delayedby-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Delayed By'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addContractorType','class' => 'contractortype-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Contractor Type'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mcagrath-crm\resources\views/project-settings/index.blade.php ENDPATH**/ ?>