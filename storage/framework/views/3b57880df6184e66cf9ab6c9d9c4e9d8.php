...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('Company Type'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
         ...
         <?php $__env->endSlot(); ?>
        <?php $__empty_1 = true; $__currentLoopData = $companyTypes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="row-<?php echo e($item->id); ?>">
                <td><?php echo e($key + 1); ?></td>
                <td data-row-id="<?php echo e($item->id); ?>" contenteditable="true"><?php echo e($item->type); ?></td>
                <td class="text-right">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createCompanyType']); ?>
        <div class="row border-top-grey">
            <div class="col-sm-12">
                <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'type','fieldLabel' => __('Type'),'fieldName' => 'type','fieldRequired' => 'true','fieldPlaceholder' => __('Enter a company type')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-company-type']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    function refreshCompanyTypes() {
        $.ajax({
            url: "<?php echo e(route('companyTypes.list')); ?>",
            type: "GET",
    ...
    $.easyAjax({
        url: "<?php echo e(route('company-types.store')); ?>",
        type: "POST",
        data: formData,
        success: function(response) {
    ...
    $('body').on('click', '.delete-row', function() {
        ...
        var url = "<?php echo e(route('company-types.destroy', ':id')); ?>".replace(':id', id);
    ...
    let url = "<?php echo e(route('company-types.update', '')); ?>/" + id;
    ...
    // });
</script><?php /**PATH C:\laragon\www\mcagrath-crm\resources\views/lead-contact/notes/companytype.blade.php ENDPATH**/ ?>