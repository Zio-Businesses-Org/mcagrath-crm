...
<?php $component->withAttributes([]); ?>
                        <input type="number" value="<?php echo e($projectSetting->remind_time); ?>" name="remind_time"
                         ...
                         <?php $__env->slot('append', null, []); ?> 
                            <span
                                class="input-group-text height-35 bg-white border-grey"><?php echo e(__('app.'.$projectSetting->remind_type)); ?></span>
                         <?php $__env->endSlot(); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views/project-settings/ajax/sendReminder.blade.php ENDPATH**/ ?>